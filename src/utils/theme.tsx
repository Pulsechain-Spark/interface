  ...
  return {
    ...
    palette: {
      ...
      background: {
        ...
        navbar: getColor(
          'radial-gradient(150% 300% at center calc(100% + 80px), #20201e, #171715)',
          'radial-gradient(200% 200% at center calc(100% + 80px), #20201e, #171715)'
        ),
        header: getColor(
          'radial-gradient(150% 300% at bottom, #20201e, #171715)',
          'radial-gradient(200% 200% at bottom, #20201e, #171715)'
        ),
      ...
      gradients: {
        aaveGradient: 'linear-gradient(to right, #1d91fe, #5551f9)',
        newGradient: 'linear-gradient(to right, #1d91fe, #5551f9)',
      },
    },
    spacing: 4,
    typography: {
